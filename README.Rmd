...
```{r figures, echo=FALSE, warnings=FALSE, fig.height=3, fig.width=3}
for (package.index in seq_along(all_packages)) {
  cat(paste0("\n## ", all_packages[package.index]), "\n")
  print(suppressWarnings(plot_package_check(all_packages[[package.index]])))
}
```
